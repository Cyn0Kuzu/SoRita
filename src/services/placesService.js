...
export const placesService = {
  ...
  async searchNearbyPlaces(latitude, longitude, radius = 1500, type = 'restaurant') {
    try {
      ...
      console.log(' [PlacesService] Places search successful:', data.results.length, 'places found');
  ...
  async getPlaceDetails(placeId) {
    try {
      ...
      const fields = 'name,formatted_address,address_components,rating,user_ratings_total,formatted_phone_number,website,opening_hours,reviews,photos,types';
  ...
  async searchPlacesByText(query, latitude, longitude) {
    try {
      ...
      console.log(' [PlacesService] Text search successful:', data.results.length, 'places found');
