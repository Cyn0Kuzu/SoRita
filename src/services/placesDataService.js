...
export class PlacesDataService {
  ...
  static async getPlace(placeId) {
    try {
      ...
      if (!placeDoc.exists()) {
        console.warn(' [PlacesDataService] Place not found:', placeId);
        return null;
      }
  ...
  static async updatePlace(placeId, updates) {
    try {
      ...
      console.log(' [PlacesDataService] Updating place:', placeId);
  ...
  static async deletePlace(placeId) {
    try {
      ...
      console.log(' [PlacesDataService] Soft deleting place:', placeId);
  ...
  static async togglePlaceLike(placeId) {
    try {
      ...
      console.log(' [PlacesDataService] Toggling like for place:', placeId);
  ...
  static async cachePlaceData(placeId, placeData) {
    try {
      ...
      console.warn(' [PlacesDataService] Cache write error:', error);
    }
  }
  ...
  static async getCachedPlaceData(placeId) {
    try {
      ...
      console.warn(' [PlacesDataService] Cache read error:', error);
      return null;
    }
  }
  ...
  static async removeCachedPlaceData(placeId) {
    try {
      ...
      console.warn(' [PlacesDataService] Cache remove error:', error);
    }
  }
  ...
  static async updateUserPlacesCount(userId, increment) {
    try {
      ...
      console.warn(' [PlacesDataService] Error updating places count:', error);
    }
  }
  ...
  static async incrementPlaceViews(placeId) {
    try {
      ...
      console.warn(' [PlacesDataService] Error updating views:', error);
    }
  }
  ...
  static async getPlacesNearLocation(latitude, longitude, radiusKm = 10) {
    try {
      console.log(` [PlacesDataService] Getting places near ${latitude}, ${longitude}`);
