...
export class ListsDataService {
  ...
  static async getList(listId) {
    try {
      ...
      if (!listDoc.exists()) {
        console.warn(' [ListsDataService] List not found:', listId);
        return null;
      }
  ...
  static async updateList(listId, updates) {
    try {
      ...
      console.log(' [ListsDataService] Updating list:', listId);
  ...
  static async removePlaceFromList(listId, placeId) {
    try {
      ...
      if (!placeEntry) {
        console.warn(' [ListsDataService] Place not found in list');
        return false;
      }
  ...
  static async deleteList(listId) {
    try {
      ...
      console.log(' [ListsDataService] Soft deleting list:', listId);
  ...
  static async toggleListLike(listId) {
    try {
      ...
      console.log(' [ListsDataService] Toggling like for list:', listId);
  ...
  static async cacheListData(listId, listData) {
    try {
      ...
      console.warn(' [ListsDataService] Cache write error:', error);
    }
  }
  ...
  static async getCachedListData(listId) {
    try {
      ...
      console.warn(' [ListsDataService] Cache read error:', error);
      return null;
    }
  }
  ...
  static async removeCachedListData(listId) {
    try {
      ...
      console.warn(' [ListsDataService] Cache remove error:', error);
    }
  }
  ...
  static async updateUserListsCount(userId, incrementValue) {
    try {
      ...
      console.warn(' [ListsDataService] Error updating lists count:', error);
    }
  }
  ...
  static async incrementListViews(listId) {
    try {
      ...
      console.warn(' [ListsDataService] Error updating views:', error);
    }
  }
